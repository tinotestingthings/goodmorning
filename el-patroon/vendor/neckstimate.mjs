...
// @freesewing/models/src/neckstimate.mjs
// Niet met de hand aanpassen -- draai `npm run assets`.
// Reden voor de kopie: hun index exporteert deze schatter niet, hun editor gebruikt hem wel. Dit bestand heeft zelf geen imports.
