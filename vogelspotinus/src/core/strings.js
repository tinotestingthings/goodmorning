...
export const STRINGS = {
  nl: {
    ...
    // Browse
    searchPlaceholder: "Zoek een dier...",
    noResults: "Geen dieren gevonden.",
    matchingBirds: "overeenkomende dieren",
    options: "Opties",
    close: "Sluiten",
    all: "Alles",
    ...
    birdsSelected: "geselecteerde dieren",
  ...
  en: {
    ...
    noResults: "No animals match your search.",
    matchingBirds: "matching animals",
    options: "Options",
    close: "Close",
    all: "All",
    ...
    birdsSelected: "animals selected",
