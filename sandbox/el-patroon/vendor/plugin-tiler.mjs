// Overgenomen uit FreeSewing 4.10.1 (MIT), bestand:
// @freesewing/react/components/Editor/lib/export/plugin-tiler.mjs
// Niet met de hand aanpassen -- draai `npm run assets`.
// Reden voor de kopie: het pad zit niet in hun exports-map en esm.sh kan het pakket niet bouwen. Dit bestand heeft zelf geen imports.
