...
export const QUESTIONS = [
  ...
  },
  {
    ...
    "options": [
      "Een zoete rode Bordeaux",
      "Een druivenras uit de Elzas",
      "Een stille rosé uit de Rhône",
      "Een Franse mousserende wijn, meestal gemaakt volgens de traditionele methode"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Het potentiële alcoholgehalte verhogen door suiker voor de gisting toe te voegen",
      "Een kurkfout verwijderen"
    ],
    "answer": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Om meer koolzuur te maken",
      "Om te controleren of wijn, producent en oogstjaar overeenkomen met de bestelling",
      "Om de kurk vochtig te maken"
    ],
    "answer": 2,
